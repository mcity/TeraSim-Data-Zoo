...
def generate_a_file(file_number: int):
    try:
        waymo_data_list = read_data("/home/led/Documents/WOMD/testing/testing.tfrecord-{:05d}-of-00150".format(file_number),)
    except:
        return
    output_file = "outputs/mapconvert_logs/0916-{:05d}.txt".format(file_number)
    ...
    with open(output_file, 'w') as file:
        ...
        for i, scenario in enumerate(waymo_data_list):
            try:
                ...
                run_with_timeout(generate_a_test_scenario, args=(scenario,), timeout=30)  # 设置超时为30秒
...
if __name__ == "__main__":
    NUM_PROCESS = 10
    for i in range(45, 150, NUM_PROCESS):
